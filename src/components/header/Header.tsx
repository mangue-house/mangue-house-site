...
const Header = () => {
    ...
    return (
        <header
            className={`scroll-smooth fixed top-0 z-50 w-full h-11 bg-primary-03/90 backdrop-blur-md transition-transform duration-300
        ...
        >
            <div className='w-full max-w-[1200px] flex justify-center md:justify-between items-center h-full mx-auto'>
                ...
                <ul className='style-none hidden md:flex md:items-center md:gap-6'>
                    <li><a href="#aboutUs"><span className='text-primary-02'>Quem somos</span></a></li>
                    <li><a href="#members"><span className='text-primary-02'>Membros</span></a></li>
